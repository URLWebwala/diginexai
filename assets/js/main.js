...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        //>> Counter Up  <<//    
        // Disabled - Using native counter implementation in count.js instead
        // The jQuery counterup plugin has a bug ($this.php is not a function)
        // Safeguard: Override counterUp if it exists to prevent errors
        if (typeof $ !== 'undefined' && typeof $.fn !== 'undefined') {
            // Override counterUp to prevent errors if plugin is accidentally loaded
            if (typeof $.fn.counterUp === 'function') {
                $.fn.counterUp = function() {
                    console.warn('⚠️ CounterUp plugin disabled - using count.js instead');
                    return this; // Return jQuery object for chaining
                };
            }
        }
        // Original code commented out - using count.js instead
