                ...
                <div class="offcanvas__content">
                    <div class="offcanvas__top mb-5 d-flex justify-content-between align-items-center">
                        <div class="offcanvas__logo">
                            <a href="<?php echo $baseDir; ?>"><img src="assets/img/diginexAilogo.png" alt="logo-img" /></a>
                        </div>
                    ...
                    <div class="mobile-menu mb-4">
                        <ul>
                            ...
                            <li><a href="<?php echo $baseDir; ?>about">About Us</a></li>
                            <li><a href="<?php echo $baseDir; ?>service">Services</a></li>
                            <li><a href="<?php echo $baseDir; ?>blog">Blog</a></li>
                            <li><a href="<?php echo $baseDir; ?>contact">Contact</a></li>
                        </ul>
                    </div>
                    <div class="offcanvas__contact">
                        ...
                        <div class="header-button">
                            <a href="<?php echo $baseDir; ?>contact" class="theme-btn bg-white"><span>Book A Demo
                ...
                <div class="mega-menu-wrapper">
                    <div class="header-main">
                        <div class="header-left">
                            <div class="logo">
                                <a href="<?php echo $baseDir; ?>" class="header-logo">
                        ...
                        <div class="header-right d-flex justify-content-end align-items-center">
                            ...
                            <div class="header-button">
                                <a href="<?php echo $baseDir; ?>contact" class="theme-btn bg-white">
